...
import io.virtualapp.home.DeepLinkPickerActivity;
...
public class App extends Application {
    ...
    private SettingConfig mConfig = new SettingConfig() {
        ...
        @Override
        public Intent getDeepLinkPickerIntent(Intent orgIntent, String packageName) {
            Intent intent = new Intent(App.this, DeepLinkPickerActivity.class);
            intent.putExtra(DeepLinkPickerActivity.EXTRA_TARGET_PACKAGE, packageName);
            intent.putExtra(DeepLinkPickerActivity.EXTRA_ORIGINAL_INTENT, new Intent(orgIntent));
            ...
            virtualCore.initialize(new VirtualCore.VirtualInitializer() {
                ...
                public void onMainProcess() {
                    try {
                        ...
                        android.util.Log.e("App", "onMainProcess init failed (non-fatal): " + e.getMessage());
                    }

                    // Device ID spoofing is handled by VDeviceManager inside the virtual process.
                    // No Xposed hook needed here — safe for non-root HyperOS / Android 13.
                }
                ...
                public void onVirtualProcess() {
                    try {
                        ...
                        android.util.Log.e("App", "onVirtualProcess init failed (non-fatal): " + e.getMessage());
                    }
                }
...
//                virtualCore.addVisibleOutsidePackage("com.immomo.momo");
                        ...
                        android.util.Log.e("App", "onServerProcess init failed (non-fatal): " + e.getMessage());
                    }
                }

            });
        } catch (Throwable e) {
            android.util.Log.e("App", "VirtualCore initialization failed (non-fatal): " + e.getMessage());
            e.printStackTrace();
            // Graceful fallback - app continues to run even if VirtualCore init fails
        }
    }
