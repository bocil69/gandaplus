...
public class PackageAppData extends AppData {
    ...
    private void loadData(Context context, ApplicationInfo appInfo) {
        ...
        try {
            android.content.SharedPreferences prefs = context.getSharedPreferences("clone_names", Context.MODE_PRIVATE);
            String customName = prefs.getString(packageName + ":0", null);
