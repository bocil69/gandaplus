...
public final class TerminalColorScheme {
    ...
    private void reset() {
        System.arraycopy(DEFAULT_COLORSCHEME, 0, this.mDefaultColors, 0, TextStyle.NUM_INDEXED_COLORS);
    }
    ...
    public void updateWith(Properties properties) {
        ...
        for (Map.Entry entry : properties.entrySet()) {
            ...
            if (str.equals("foreground")) {
                ...
                parseInt = TextStyle.COLOR_INDEX_CURSOR;
            ...
            this.mDefaultColors[parseInt] = parse;
        }
    }
}
