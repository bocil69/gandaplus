...
public final class QueryParams {
    ...
    public Map<String, Object> getWireProtocolParams() {
        ...
        if (obj != null) {
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$firebase$database$core$view$QueryParams$ViewFrom[viewFromToAdd.ordinal()]) {
                case 1:
    ...
    public int hashCode() {
        ...
        Index index = this.index;
        return result6 + (index != null ? index.hashCode() : 0);
    }
