...
public class ShapePath {
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            Double.isNaN(d);
            matrix2.preTranslate((float) ((-d2) - d), (-2.0f) * min);
            Double.isNaN(d);
            shadowRenderer.drawInnerCornerShadow(canvas, this.renderMatrix, rectF2, (int) min, 450.0f, sweepAngle, new float[]{(float) (d + d2), f});
            if (hypot2 > d2) {
