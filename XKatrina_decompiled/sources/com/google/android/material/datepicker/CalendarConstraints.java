...
public final class CalendarConstraints implements Parcelable {
    ...
    private CalendarConstraints(@NonNull Month month, @NonNull Month month2, @NonNull DateValidator dateValidator, @Nullable Month month3, int i) {
        CalendarConstraints$$ExternalSyntheticBackport0.m(month, "start cannot be null");
        CalendarConstraints$$ExternalSyntheticBackport0.m(month2, "end cannot be null");
        CalendarConstraints$$ExternalSyntheticBackport0.m(dateValidator, "validator cannot be null");
        this.start = month;
        this.end = month2;
        this.openAt = month3;
    ...
    public static final class Builder {
        ...
        public Builder setValidator(@NonNull DateValidator dateValidator) {
            CalendarConstraints$Builder$$ExternalSyntheticBackport0.m(dateValidator, "validator cannot be null");
            this.validator = dateValidator;
            return this;
        }
