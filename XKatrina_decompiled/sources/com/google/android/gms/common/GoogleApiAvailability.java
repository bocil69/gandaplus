...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final boolean zac(@RecentlyNonNull Context context, @RecentlyNonNull ConnectionResult connectionResult, int i) {
        ...
        if (errorResolutionPendingIntent != null) {
            zab(context, connectionResult.getErrorCode(), null, PendingIntent.getActivity(context, 0, GoogleApiActivity.zaa(context, errorResolutionPendingIntent, i, true), FileSystemManager.MODE_CREATE));
            return true;
        }
        return false;
    }
