...
public final class zzalr {
    ...
    public static void zzb(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                sb.append(zzamq.zza(new zzajc(((String) obj).getBytes(zzakq.zzb))));
                sb.append('\"');
            } else if (obj instanceof zzajf) {
                sb.append(": \"");
                sb.append(zzamq.zza((zzajf) obj));
                sb.append('\"');
            } else if (obj instanceof zzakk) {
                sb.append(" {");
                zzd((zzakk) obj, sb, i + 2);
                sb.append("\n");
                zzc(i, sb);
                sb.append("}");
    ...
    private static void zzd(zzalp zzalpVar, StringBuilder sb, int i) {
        int i2;
        boolean equals;
        Method method;
        Method method2;
            ...
            if (!substring.endsWith("List") || substring.endsWith("OrBuilderList") || substring.equals("List") || (method2 = (Method) entry.getValue()) == null || !method2.getReturnType().equals(List.class)) {
                if (!substring.endsWith("Map") || substring.equals("Map") || (method = (Method) entry.getValue()) == null || !method.getReturnType().equals(Map.class) || method.isAnnotationPresent(Deprecated.class) || !Modifier.isPublic(method.getModifiers())) {
                    if (hashSet.contains("set".concat(String.valueOf(substring))) && (!substring.endsWith("Bytes") || !treeMap.containsKey("get".concat(String.valueOf(substring.substring(0, substring.length() - 5)))))) {
                        ...
                        if (method4 != null) {
                            Object zzD = zzakk.zzD(method4, zzalpVar, new Object[0]);
                            if (method5 == null) {
                                ...
                                if (!((Boolean) zzakk.zzD(method5, zzalpVar, new Object[0])).booleanValue()) {
                                }
                                zzb(sb, i, substring, zzD);
                            }
                        }
                    ...
                    zzb(sb, i, substring.substring(0, substring.length() - 3), zzakk.zzD(method, zzalpVar, new Object[0]));
                }
            } else {
                zzb(sb, i, substring.substring(0, substring.length() - 4), zzakk.zzD(method2, zzalpVar, new Object[0]));
            }
            i2 = 3;
        }
        ...
        zzakc zzakcVar = ((zzakh) zzalpVar).zzb;
        throw null;
    }
}
