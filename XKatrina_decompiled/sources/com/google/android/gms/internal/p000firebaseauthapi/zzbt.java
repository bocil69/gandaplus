...
final class zzbt {
    ...
    */
    private final synchronized void zzg(com.google.android.gms.internal.p000firebaseauthapi.zzbs r7, boolean r8) throws java.security.GeneralSecurityException {
        /*
            r6 = this;
            monitor-enter(r6)
            ...
            com.google.android.gms.internal.firebase-auth-api.zzbs r1 = (com.google.android.gms.internal.p000firebaseauthapi.zzbs) r1     // Catch: java.lang.Throwable -> L6b
            if (r1 == 0) goto L5b
        ...
        L22:
            ...
            java.util.logging.Logger r2 = com.google.android.gms.internal.p000firebaseauthapi.zzbt.zza     // Catch: java.lang.Throwable -> L6b
        ...
        L6b:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p000firebaseauthapi.zzbt.zzg(com.google.android.gms.internal.firebase-auth-api.zzbs, boolean):void");
    }
    ...
    public final synchronized void zzc(zzon zzonVar, zzng zzngVar) throws GeneralSecurityException {
        Class zzd;
        if (!zzij.zza(1)) {
            String valueOf = String.valueOf(zzonVar.getClass());
            throw new GeneralSecurityException("failed to register key manager " + valueOf + " as it is not FIPS compatible.");
        } else if (zzij.zza(zzngVar.zzf())) {
            String zzd2 = zzonVar.zzd();
            String zzd3 = zzngVar.zzd();
            if (this.zzb.containsKey(zzd2) && ((zzbs) this.zzb.get(zzd2)).zzd() != null && (zzd = ((zzbs) this.zzb.get(zzd2)).zzd()) != null && !zzd.getName().equals(zzngVar.getClass().getName())) {
                Logger logger = zza;
                ...
                throw new GeneralSecurityException(String.format("public key manager corresponding to %s is already registered with %s, cannot be re-registered with %s", zzonVar.getClass().getName(), zzd.getName(), zzngVar.getClass().getName()));
            }
            zzg(new zzbr(zzonVar, zzngVar), true);
            zzg(new zzbq(zzngVar), false);
        } else {
            String valueOf2 = String.valueOf(zzngVar.getClass());
    ...
    public final synchronized void zzd(zzng zzngVar) throws GeneralSecurityException {
        if (zzij.zza(zzngVar.zzf())) {
            ...
            String valueOf = String.valueOf(zzngVar.getClass());
            throw new GeneralSecurityException("failed to register key manager " + valueOf + " as it is not FIPS compatible.");
        }
    }
