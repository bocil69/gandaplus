...
public final class zzaeb extends AsyncTask {
    ...
    public zzaeb(String str, String str2, Intent intent, FirebaseApp firebaseApp, zzaed zzaedVar) {
        ...
        Uri.Builder buildUpon = Uri.parse(zzaedVar.zzc(checkNotEmpty)).buildUpon();
    ...
    public final void onPostExecute(zzaea zzaeaVar) {
        ...
        if (zzaedVar == null) {
            ...
            zzaedVar.zze(this.zzb, zzai.zza(str));
        } else {
            builder.authority(str2);
            zzaedVar.zzf(this.zze.build(), this.zzb, FirebaseAuth.getInstance(this.zzg).zzE());
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:11:0x0077 A[Catch: zzaca -> 0x00fa, NullPointerException -> 0x0111, IOException -> 0x0128, TryCatch #1 {IOException -> 0x0128, blocks: (B:6:0x0014, B:8:0x0054, B:9:0x0071, B:11:0x0077, B:13:0x0085, B:15:0x008d, B:27:0x00dc, B:26:0x00ca), top: B:38:0x0014 }] */
    ...
    */
    protected final /* bridge */ /* synthetic */ java.lang.Object doInBackground(java.lang.Object[] r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p000firebaseauthapi.zzaeb.doInBackground(java.lang.Object[]):java.lang.Object");
    }
