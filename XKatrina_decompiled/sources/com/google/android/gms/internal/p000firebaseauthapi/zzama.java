...
interface zzama {
    ...
    @Deprecated
    void zzC(List list, zzamb zzambVar, zzajx zzajxVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzamb zzambVar, zzajx zzajxVar) throws IOException;
    ...
    void zzt(Object obj, zzamb zzambVar, zzajx zzajxVar) throws IOException;

    void zzu(Object obj, zzamb zzambVar, zzajx zzajxVar) throws IOException;
