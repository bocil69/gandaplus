...
final class zzakl extends zzaiq implements RandomAccess, zzakp, zzalw {
    ...
    public final boolean addAll(Collection collection) {
        ...
        zzakl zzaklVar = (zzakl) collection;
        int i = zzaklVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzaklVar.zzb, 0, this.zzb, this.zzc, zzaklVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzakl) {
            ...
            if (this.zzc != zzaklVar.zzc) {
                return false;
            }
            int[] iArr = zzaklVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzakp zzd(int i) {
        ...
        return new zzakl(Arrays.copyOf(this.zzb, i), this.zzc, true);
    }
    ...
    private zzakl(int[] iArr, int i, boolean z) {
        super(z);
        this.zzb = iArr;
        this.zzc = i;
    }
