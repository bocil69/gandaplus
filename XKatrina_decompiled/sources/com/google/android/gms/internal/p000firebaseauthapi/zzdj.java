...
public final class zzdj {
    ...
    public final zzdj zza(int i) throws GeneralSecurityException {
        if (i == 16 || i == 24 || i == 32) {
    ...
    public final zzdj zze(int i) throws GeneralSecurityException {
        if (i < 10) {
    ...
    public final zzdj zzc(int i) throws GeneralSecurityException {
        if (i < 16) {
    ...
    public final zzdj zzd(int i) throws GeneralSecurityException {
        if (i < 12 || i > 16) {
