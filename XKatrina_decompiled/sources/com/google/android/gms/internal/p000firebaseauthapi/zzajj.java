...
public final class zzajj extends zzajl {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzajj(InputStream inputStream, int i, zzaji zzajiVar) {
        super(null);
    ...
    @Override // com.google.android.gms.internal.p000firebaseauthapi.zzajl
    ...
    public final zzajf zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (zzj <= i - i2 && zzj > 0) {
            zzajf zzn = zzajf.zzn(this.zzf, i2, zzj);
            this.zzi += zzj;
            return zzn;
        } else if (zzj != 0) {
            byte[] zzN = zzN(zzj);
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i2 = this.zzi;
            if (zzj <= i - i2) {
                String str = new String(this.zzf, i2, zzj, zzakq.zzb);
                this.zzi += zzj;
                return str;
            }
        }
        ...
        if (zzj <= this.zzg) {
            zzK(zzj);
            String str2 = new String(this.zzf, this.zzi, zzj, zzakq.zzb);
            this.zzi += zzj;
            return str2;
        }
        return new String(zzM(zzj, false), zzakq.zzb);
    }
    ...
    */
    public final int zzj() throws java.io.IOException {
        ...
        L6d:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p000firebaseauthapi.zzajj.zzj():int");
    }
