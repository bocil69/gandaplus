...
public class AdvertisingIdClient {
    ...
    public static final class Info {
        ...
        public final String toString() {
            String str = this.zzq;
            return new StringBuilder(7 + String.valueOf(str).length()).append("{").append(str).append("}").append(this.zzr).toString();
        }
    }
    ...
    private static BlockingServiceConnection zza(Context context, boolean z) throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        try {
            ...
            switch (GoogleApiAvailabilityLight.getInstance().isGooglePlayServicesAvailable(context, GooglePlayServicesUtilLight.GOOGLE_PLAY_SERVICES_VERSION_CODE)) {
                case 0:
                case 2:
