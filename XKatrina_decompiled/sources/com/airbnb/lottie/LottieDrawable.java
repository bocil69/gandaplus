...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public /* synthetic */ void m12lambda$new$0$comairbnblottieLottieDrawable(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m13lambda$new$1$comairbnblottieLottieDrawable() {
        CompositionLayer compositionLayer = this.compositionLayer;
        if (compositionLayer == null) {
            return;
        }
    ...
    public LottieDrawable() {
        ...
        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                LottieDrawable.this.m12lambda$new$0$comairbnblottieLottieDrawable(valueAnimator);
            }
        };
        ...
        this.updateProgressRunnable = new Runnable() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda1
            ...
            public final void run() {
                LottieDrawable.this.m13lambda$new$1$comairbnblottieLottieDrawable();
            }
        };
        ...
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda13
                ...
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m14lambda$playAnimation$2$comairbnblottieLottieDrawable(lottieComposition);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m14lambda$playAnimation$2$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        playAnimation();
    }
    ...
    public void resumeAnimation() {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda7
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m15lambda$resumeAnimation$3$comairbnblottieLottieDrawable(lottieComposition);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m15lambda$resumeAnimation$3$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        resumeAnimation();
    }
    ...
    public void setMinFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda4
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m24lambda$setMinFrame$4$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    public /* synthetic */ void m24lambda$setMinFrame$4$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setMinFrame(i);
    }
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda5
                ...
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m26lambda$setMinProgress$5$comairbnblottieLottieDrawable(f, lottieComposition2);
                }
            });
        } else {
    ...
    public /* synthetic */ void m26lambda$setMinProgress$5$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMinProgress(f);
    }
    ...
    public void setMaxFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda6
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m17lambda$setMaxFrame$6$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    public /* synthetic */ void m17lambda$setMaxFrame$6$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setMaxFrame(i);
    }
    ...
    public void setMaxProgress(@FloatRange(from = 0.0d, to = 1.0d) final float f) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda12
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m19lambda$setMaxProgress$7$comairbnblottieLottieDrawable(f, lottieComposition2);
                }
            });
        } else {
    ...
    public /* synthetic */ void m19lambda$setMaxProgress$7$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMaxProgress(f);
    }
    ...
    public void setMinFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda10
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m25lambda$setMinFrame$8$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m25lambda$setMinFrame$8$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMinFrame(str);
    }
    ...
    public void setMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda8
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m18lambda$setMaxFrame$9$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m18lambda$setMaxFrame$9$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMaxFrame(str);
    }
    ...
    public void setMinAndMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda16
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m20lambda$setMinAndMaxFrame$10$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m20lambda$setMinAndMaxFrame$10$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final String str, final String str2, final boolean z) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda9
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m21lambda$setMinAndMaxFrame$11$comairbnblottieLottieDrawable(str, str2, z, lottieComposition2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m21lambda$setMinAndMaxFrame$11$comairbnblottieLottieDrawable(String str, String str2, boolean z, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final int i, final int i2) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda15
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m22lambda$setMinAndMaxFrame$12$comairbnblottieLottieDrawable(i, i2, lottieComposition);
                }
            });
        } else {
    ...
    public /* synthetic */ void m22lambda$setMinAndMaxFrame$12$comairbnblottieLottieDrawable(int i, int i2, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxProgress(@FloatRange(from = 0.0d, to = 1.0d) final float f, @FloatRange(from = 0.0d, to = 1.0d) final float f2) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda3
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m23lambda$setMinAndMaxProgress$13$comairbnblottieLottieDrawable(f, f2, lottieComposition2);
                }
            });
        } else {
    ...
    public /* synthetic */ void m23lambda$setMinAndMaxProgress$13$comairbnblottieLottieDrawable(float f, float f2, LottieComposition lottieComposition) {
    ...
    public void setFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda14
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m16lambda$setFrame$14$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    public /* synthetic */ void m16lambda$setFrame$14$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setFrame(i);
    }
    ...
    public void setProgress(@FloatRange(from = 0.0d, to = 1.0d) final float f) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda2
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m27lambda$setProgress$15$comairbnblottieLottieDrawable(f, lottieComposition);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m27lambda$setProgress$15$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setProgress(f);
    }
    ...
    public <T> void addValueCallback(final KeyPath keyPath, final T t, @Nullable final LottieValueCallback<T> lottieValueCallback) {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda11
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m11lambda$addValueCallback$16$comairbnblottieLottieDrawable(keyPath, t, lottieValueCallback, lottieComposition);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m11lambda$addValueCallback$16$comairbnblottieLottieDrawable(KeyPath keyPath, Object obj, LottieValueCallback lottieValueCallback, LottieComposition lottieComposition) {
