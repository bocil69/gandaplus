...
public class Oscillator {
    ...
    double getP(double time) {
        ...
        double d2 = this.mArea[index2 - 1];
        double d3 = fArr[index2 - 1];
        Double.isNaN(d3);
        double p = d2 + ((d3 - (dArr[index2 - 1] * m)) * (t - dArr[index2 - 1])) + ((((t * t) - (dArr[index2 - 1] * dArr[index2 - 1])) * m) / 2.0d);
        return p;
    }
    ...
    double getDP(double time) {
        ...
        Double.isNaN(d);
        double m = d / (dArr[index2] - dArr[index2 - 1]);
        double d2 = fArr[index2 - 1];
        Double.isNaN(d2);
        double p = (m * t) + (d2 - (dArr[index2 - 1] * m));
        return p;
    }
