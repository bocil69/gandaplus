...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void getCenter(double p, int[] toUse, double[] data, float[] point, double[] vdata, float[] velocity) {
        ...
        if (motionController == null) {
            ...
            Double.isNaN(d6);
            Double.isNaN(d5);
            double d7 = v_height / 2.0f;
            Double.isNaN(d7);
            float v_y2 = (float) ((d5 - (d6 * cos)) - d7);
            double d8 = drx;
            double d9 = dradius;
            ...
            double d10 = dangle2;
            Double.isNaN(d10);
            float dpos_x = (float) (d8 + (d9 * sin2) + (cos2 * d10));
            double d11 = v_x3;
            double d12 = dradius;
            double cos3 = Math.cos(angle);
            Double.isNaN(d12);
            Double.isNaN(d11);
            double d13 = d11 - (d12 * cos3);
        ...
        while (true) {
            ...
            if (i2 < dArr.length) {
                ...
                if (motionController != null) {
                    ...
                    Double.isNaN(d6);
                    Double.isNaN(d5);
                    double d7 = v_height2 / 2.0f;
                    Double.isNaN(d7);
                    float pos_y = (float) ((d5 - (d6 * cos)) - d7);
                    double d8 = v_y4;
                    double d9 = dradius;
                    double sin2 = Math.sin(angle);
                    Double.isNaN(d9);
                    ...
                    double d12 = dangle2;
                    Double.isNaN(d12);
                    float dpos_x = (float) (d10 + (d11 * cos2 * d12));
                    double d13 = dry;
                    double d14 = dradius;
                    double cos3 = Math.cos(angle);
                    Double.isNaN(d14);
                    ...
                    double d18 = dangle2;
                    Double.isNaN(d18);
                    float dpos_y = (float) (d15 + (d17 * d18));
                    v_x = pos_x;
                    if (slope.length < 2) {
                        z = true;
                    } else {
                    ...
                    if (!Float.isNaN(path_rotate)) {
                        ...
                        Double.isNaN(d21);
                        Double.isNaN(d20);
                        float rot2 = (float) (d20 + d21 + degrees2);
