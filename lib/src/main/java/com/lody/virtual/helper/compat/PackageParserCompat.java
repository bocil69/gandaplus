...
import com.lody.virtual.helper.compat.PackageParserAndroid14Compat;
...
public class PackageParserCompat {
    ...
    public static void collectCertificates(PackageParser parser, Package p, int flags) throws Throwable {
        if (API_LEVEL >= 34) { // Android 14: use safe shim that handles reflection internally
            PackageParserAndroid14Compat.collectCertificates(parser, p, flags);
