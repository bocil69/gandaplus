...
public class BroadcastSystem {
    ...
    public void startApp(VPackage p) {
        ...
        for (VPackage.ActivityComponent receiver : p.receivers) {
            ...
            ReceiverCompat.registerReceiver(mContext, r, componentFilter, null, mScheduler, true);
            receivers.add(r);
            ...
            for (VPackage.ActivityIntentInfo ci : receiver.intents) {
                ...
                ReceiverCompat.registerReceiver(mContext, r, cloneFilter, null, mScheduler, true);
            }
        }
    }
