...
class MethodProxies {
    ...
    static class GetNotificationChannelGroups extends ReplaceCallingPkgMethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            List<NotificationChannelGroup> list = slice ? (List<NotificationChannelGroup>) ParceledListSlice.getList.call(ret) : (List<NotificationChannelGroup>) ret;
            if (list != null) {
    ...
    static class GetNotificationChannels extends ReplaceCallingPkgMethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            boolean slice = ParceledListSliceCompat.isReturnParceledListSlice(method);
            List<NotificationChannel> list = slice ? (List<NotificationChannel>) ParceledListSlice.getList.call(result) : (List<NotificationChannel>) result;
            if (list != null) {
                for (int i = list.size() - 1; i >= 0; i--) {
    ...
    static class GetAppActiveNotifications extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            boolean slice = ParceledListSliceCompat.isReturnParceledListSlice(method);
            List<StatusBarNotification> resultList = slice ? (List<StatusBarNotification>) ParceledListSlice.getList.call(list) : (List<StatusBarNotification>) list;
            if (resultList != null) {
