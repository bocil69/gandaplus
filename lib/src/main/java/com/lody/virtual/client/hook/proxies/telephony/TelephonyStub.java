...
public class TelephonyStub extends BinderInvocationProxy {
	...
	protected void onBindMethods() {
        ...
        addMethodProxy(new MethodProxies.GetSimSerialNumber());
        addMethodProxy(new MethodProxies.GetNetworkOperator());
        addMethodProxy(new MethodProxies.GetNetworkOperatorName());
        addMethodProxy(new MethodProxies.GetNetworkCountryIso());
        addMethodProxy(new MethodProxies.GetSimOperator());
        addMethodProxy(new MethodProxies.GetSimOperatorName());
        addMethodProxy(new MethodProxies.GetSimCountryIso());
