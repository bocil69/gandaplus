...
class MethodProxies {
                    ...
                    new InvocationHandler() {
                        ...
                        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                            switch (method.getName()) {
                                ...
                                case "abandonSession": {
                                    vInstaller.abandonSession(readIntArg(args, 0));
                                    return 0;
                                }
                                case "openSession": {
                                    return vInstaller.openSession(readIntArg(args, 0));
                                }
                                case "getSessionInfo": {
                                    SessionInfo info = vInstaller.getSessionInfo(readIntArg(args, 0));
                                    if (info != null) {
                                        return info.alloc();
                                    }
                                    return null;
    ...
    static class QueryIntentServices extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            List<ResolveInfo> appResult = VPackageManager.get().queryIntentServices((Intent) args[0],
                    (String) args[1], readIntArg(args, 2), userId);
    ...
    static class GetPermissionInfo extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            String name = (String) args[0];
            int flags = readIntArg(args, args.length - 1);
    ...
    static final class GetPackageInfo extends MethodProxy {
        ...
        private static long readFlags(Object[] args) {
            Object flagsObject = args[1];
            if (flagsObject instanceof Number) {
                return ((Number) flagsObject).longValue();
            }
            return 0L;
        }

        private static void writeFlags(Method method, Object[] args, long flags) {
            Class<?>[] parameterTypes = method.getParameterTypes();
            if (parameterTypes.length > 1 && (parameterTypes[1] == long.class || parameterTypes[1] == Long.class)) {
                args[1] = flags;
            } else {
                args[1] = (int) flags;
            }
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            String pkg = (String) args[0];
            long flags = readFlags(args);
            int userId = VUserHandle.myUserId();
            if ((flags & MATCH_ANY_USER) != 0) {
                flags &= ~MATCH_ANY_USER;
                writeFlags(method, args, flags);
            }
    ...
    static class GetInstalledApplications extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            List<ApplicationInfo> hostResult = slice ? (List<ApplicationInfo>) ParceledListSlice.getList.call(_hostResult)
                    : (List<ApplicationInfo>) _hostResult;
    ...
    static class GetInstalledPackages extends MethodProxy {
        ...
        private boolean shouldHideHostPackage(PackageInfo info) {
            if (info == null || TextUtils.isEmpty(info.packageName)) {
                return true;
            }
            String packageName = info.packageName;
            if (TextUtils.equals(packageName, getAppPkg())) {
                return true;
            }
            if (VirtualCore.get().isAppInstalled(packageName)) {
                return true;
            }
            return !isVisiblePackage(packageName);
        }
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            List<PackageInfo> hostResult = slice ? (List<PackageInfo>) ParceledListSlice.getList.call(_hostResult)
                    : (List<PackageInfo>) _hostResult;
            if (hostResult != null) {
                Iterator<PackageInfo> it = hostResult.iterator();
                while (it.hasNext()) {
                    PackageInfo info = it.next();
                    if (shouldHideHostPackage(info)) {
                        it.remove();
                        continue;
                    }
